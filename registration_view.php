        ...
        <div id="page-wrapper">
			...
			<div class="panel panel-info">
			  ...
			  <a href="registration_edit.php?id=<?php echo $_GET['id'];?>" class="btn btn-xs btn-primary" style="float:right"><span class=" glyphicon glyphicon-pencil"></span> Edit</a>
				...
				<?php echo $_GET['id'];?> - <?php h($i[0]['first_name'] . " " . $i[0]['middle_name'] . " " . $i[0]['last_name'] . " " . $i[0]['suffix']);?></h3>
			  </div>
				...
				<div class="row">
					 <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <?php h($i[0]['first_name']);?>
                            </div>
					</div>
                    <div class="col-lg-3">
                            <div class="form-group">
                                <label>Middle Name:</label> <br>
                                <?php if(empty($i[0]['middle_name'])) echo "-"; else h($i[0]['middle_name']);?>
                            </div>
                    </div>
					 <div class="col-lg-3">
                            <div class="form-group">
					...
					<div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <?php if(empty($i[0]['suffix'])) echo "-"; else h($i[0]['suffix']);?>
                            </div>
                    </div>
                </div>
				...
				<div class="row">
					 <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <?php h($i[0]['address_line_1']);?>
                            </div>
					</div>
					 <div class="col-lg-3">
                            <div class="form-group">
                                <label>Address Line 2:</label> <br>
                                <?php if(empty($i[0]['address_line_2'])) echo "-"; else h($i[0]['address_line_2']);?>
                            </div>
					</div>
					 <div class="col-lg-2">
                            <div class="form-group">
                                <label>Address Line 3:</label> <br>
                                <?php if(empty($i[0]['address_line_3'])) echo "-"; else h($i[0]['address_line_3']);?>
                            </div>
					</div>
					 <div class="col-lg-2">
                            <div class="form-group">
                                <label>Address Line 4:</label><br>
                                <?php if(empty($i[0]['address_line_4'])) echo "-"; else h($i[0]['address_line_4']);?>
                            </div>
					</div>
					 <div class="col-lg-2">
                            <div class="form-group">
                                <label>Address Line 5:</label> <br>
                                <?php if(empty($i[0]['address_line_5'])) echo "-"; else h($i[0]['address_line_5']);?>
                            </div>
					</div>
                </div>
				...
				<div class="row">
					<div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <?php h($i[0]['citizenship']);?>
                            </div>
					</div>
					<div class="col-lg-3">
                            <div class="form-group">
                                <label>Contact Number:</label><br>
                                <?php h($i[0]['contact_number']);?>
                            </div>
					</div>
                </div>
